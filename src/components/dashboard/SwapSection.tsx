    ...
    <div className="bg-black rounded-lg p-6 border border-[#2C2C2C]">
      ...
      <div className="mb-6">
        ...
        <div className="bg-[#1A1A1A] rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <button className="flex items-center bg-[#2C2C2C] hover:bg-[#3A3A3A] px-3 py-2 rounded-lg transition-colors">
              <span className="text-white font-satoshi mr-2">Select Token</span>
              <ChevronDown size={16} className="text-gray-400" />
            </button>
          </div>
          <input
      ...
      {/* Swap Button */}
      <button className="w-full bg-[#E2AF19] hover:bg-[#D4A853] text-black font-semibold py-3 rounded-lg transition-colors font-satoshi">
        Swap
      </button>
      ...
      <div className="mt-6 pt-6 border-t border-[#2C2C2C]">
        ...
        <p className="text-gray-400 text-sm font-satoshi leading-relaxed">
          Blockpal is a modern crypto wallet that makes managing your digital
          assets easy and stress-free. Whether you're sending tokens, tracking
          your balance, or planning future payments, Blockpal brings everything
          you need to one streamlined space.
        </p>
        <p className="text-gray-400 text-sm font-satoshi mt-3">
