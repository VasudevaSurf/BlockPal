...
export default function SimpleTransferModal({
  ...
  const handleExecuteTransfer = async () => {
    ...
    try {
      // In test mode, we need the private key - for demo purposes only
      ...
      const response = await fetch("/api/transfer/simple", {
        ...
        body: JSON.stringify({
          ...
          amount: formData.amount,
          fromAddress: walletAddress,
          privateKey: testPrivateKey, // WARNING: This is only for testing!
          tokenPrice: tokenInfo.priceData?.current_price,
        }),
        credentials: "include",
      });
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFormData({
                          ...formData,
                          recipientAddress:
                            "0x2Ef3C895f7A18088B384cA4bc3a19558351B7313",
                        })
                      }
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFormData({
                          ...formData,
                          recipientAddress:
                            "0xCAEAd2fC03e370107b097965971ebeCF19eB5226",
                        })
                      }
                      className="text-xs bg-[#2C2C2C] text-gray-300 px-2 py-1 rounded font-satoshi hover:bg-[#3C3C3C] transition-colors"
                    >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-blue-400 text-sm font-satoshi font-medium mb-1">
                      🧪 Sepolia Testnet Transfer
                    </p>
                    <p className="text-blue-400 text-xs font-satoshi">
                      This is a real testnet transaction. You can send tokens to
                      the test wallets provided above. Current balance:{" "}
              ...
              <div className="bg-yellow-900/20 border border-yellow-500/50 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <p className="text-yellow-400 text-sm font-satoshi">
                    This is a testnet transaction with no real value. Please
