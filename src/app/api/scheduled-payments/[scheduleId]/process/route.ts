// src/app/api/scheduled-payments/[scheduleId]/process/route.ts - UPDATED VERSION
    ...
    const result = await db.collection("schedules").findOneAndUpdate(
      {
        ...
        $or: [
          ...
          {
            processingStarted: {
              $lt: new Date(now.getTime() - 120000), // 2 minutes ago
            },
          },
        ],
        ...
        $and: [
          {
            $or: [
              ...
              {
                lastExecutionAt: {
                  $lt: new Date(now.getTime() - 60000), // 1 minute ago
                },
              },
            ],
          },
