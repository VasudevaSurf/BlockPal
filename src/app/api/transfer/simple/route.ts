// src/app/api/transfer/simple/route.ts (UPDATED WITH ENHANCED SERVICE)
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === "preview") {
      // Create transfer preview using enhanced service
      try {
      ...
      // Execute transfer using enhanced service
