// src/app/dashboard/swap/page.tsx - Fixed Responsive Version
"use client";
...
export default function SwapPage() {
  ...
  const SwapCardContent = () => (
    <div className="py-3 lg:py-4 px-3 lg:px-16">
      {/* Chain selector and slippage - Rest of the swap card content stays the same */}
      <div className="flex flex-row items-center justify-between mb-3 lg:mb-4 gap-2">
        ...
        {/* Slippage settings - keeping original code */}
        <div className="relative">
          ...
          {/* Slippage Settings Modal - keeping original */}
      ...
      {/* From Token Box - keeping original with responsive tweaks */}
    ...
    `,
      ...
      {/* To Token Box - keeping original with responsive tweaks */}
      <div
    ...
    <div className="h-full bg-[#000000] rounded-[12px] lg:rounded-[16px] flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-3 lg:p-4 relative z-20">
        ...
        <div className="mb-4 lg:mb-8 relative z-20">
          <h1 className="text-[30px] font-mayeka-demi-bold-demo font-bold text-center bg-gradient-to-r from-[#F5E4B2] to-[#E2AF19] bg-clip-text text-transparent px-2">
        ...
        <div className="mb-4 lg:mb-6 relative z-20">
          <div className="relative inline-flex py-[4px] lg:py-[6px] px-[4px] lg:px-[6px] gap-[4px] lg:gap-[6px] border border-[#4B3A08] rounded-[12px]">
            <motion.div
              ...
              animate={activeTab}
              variants={{
                swap: { x: 0, width: "calc(50% - 2px)" },
                history: { x: "calc(80% + 2px)", width: "calc(52% - 2px)" },
              }}
              transition={{
                type: "spring",
                stiffness: 500,
        ...
        {activeTab === "history" && (
          <>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="hidden lg:block fixed inset-0 bg-white/10 z-20"
              onClick={() => setActiveTab("swap")}
            />
