  ...
  return (
    <>
      ...
      <div className="h-full bg-[#000000] rounded-[12px] lg:rounded-[14px] p-0 lg:p-2.5 flex flex-col overflow-hidden token-overview-page">
        ...
        <div className="lg:hidden flex items-center justify-between p-3 border-b border-[#2C2C2C] bg-black flex-shrink-0">
          <button
            onClick={() => router.back()}
          ...
          <h1 className="text-white text-base font-mayeka font-semibold">
            Token Overview
          </h1>
          <button
        ...
        <div className="lg:hidden flex-1 overflow-y-auto pb-24 mobile-token-content">
            ...
            <div className="p-3 space-y-3 pb-6">
              ...
              <div className="bg-black rounded-[11px] border border-[#2C2C2C] p-2.5">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h2 className="text-base font-bold text-white font-mayeka">
                        {metadata.name}
                      </h2>
                  ...
                  <div className="flex gap-1.5 mb-2">
                    {metadata.socials?.twitter && (
                      <a
                        ...
                        className="p-1.5 bg-[#0F0F0F] rounded-lg hover:bg-[#1A1A1A] transition-colors"
                      >
              ...
              <div className="bg-black rounded-[11px] border border-[#2C2C2C] p-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex-1 mr-2">
                    <div className="text-gray-400 text-[9px] font-satoshi mb-1">
                      Contract Address
                    </div>
                    <code className="text-gray-300 font-mono text-[11px] break-all">
                      {contractAddress}
                    </code>
                  </div>
                  <button
              ...
              <div className="bg-black rounded-[11px] border border-[#2C2C2C] p-2.5">
                <div className="mb-2">
                  ...
                  <div className="relative h-1.5 bg-[#1a1a1a] rounded-full overflow-hidden mb-1.5">
                    {(() => {
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-xs font-satoshi text-[#26AA5E]">
                      {transactions.buys24h || 0}
                    </div>
                    <div className="text-xs font-satoshi text-[#F44336]">
                      {transactions.sells24h || 0}
                    </div>
                  </div>
                </div>

                <div className="bg-[#0F0F0F] p-2.5 rounded-lg space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-400 text-xs font-satoshi">
                      Transactions
                    </span>
                    <span className="text-white text-xs font-semibold font-satoshi">
          ...
          {activeTab === "chart" && (
            <div className="p-3 space-y-3 pb-6">
              ...
              <div className="flex items-center gap-2 bg-black rounded-[11px] p-2.5">
                <div className="w-8 h-8 rounded-full flex items-center justify-center bg-[#2C2C2C] border-2 border-[#00D9B3]/20">
                  {metadata.logo ? (
                    ...
                    <span className="text-[#00D9B3] text-sm font-bold">
                      {(metadata.symbol || "?").charAt(0)}
                    </span>
                  )}
                </div>
                <div className="flex-1">
                  <div className="text-white text-sm font-semibold font-satoshi mb-0.5">
                    {metadata.name} ({metadata.symbol})
                  </div>
                  <div className="text-[#00D9B3] text-base font-medium font-satoshi">
                    {formatPrice(marketData.price || 0)}
                  </div>
                </div>
              </div>
                ...
                {poolAddress ? (
                  ...
                  <div className="h-full flex items-center justify-center flex-col gap-2">
                    <div className="text-gray-500 text-xs text-center">
                      <p className="mb-1">📊 Chart data not available</p>
              ...
              {/* PAL Score Section - Now part of Chart Tab */}
          ...
          <nav className="flex items-center justify-around px-4 py-3">
            ...
            >
              <svg
                ...
                className={`mb-1 ${
                  activeTab === "info" ? "text-[#E2AF19]" : "text-white"
                }`}
              >
            ...
            >
              <svg
                ...
                strokeLinejoin="round"
                className={`mb-1 ${
                  activeTab === "chart" ? "text-[#E2AF19]" : "text-white"
                }`}
              >
