...
export default function BatchPaymentsPage() {
  ...
  const executeBatch = async () => {
    ...
    try {
      // For demo purposes, using test private key
      ...
      <div className="bg-blue-900/20 border border-blue-500/50 rounded-lg p-3 mb-4 flex-shrink-0">
        <div className="flex items-center">
          <span className="text-blue-400 text-sm font-satoshi font-medium">
            🧪 SEPOLIA TESTNET - Real Batch Transfers Enabled
          </span>
        </div>
      </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-400 text-xs font-satoshi">
                        This will execute a real batch transfer on Sepolia
                        testnet. Please verify all details before proceeding.
                      </p>
                    </div>
                  </div>
                </div>
